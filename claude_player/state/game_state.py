...
class GameState:
    ...
    def __init__(self):
        ...
        self.runtime_thinking_enabled = False  # Store the runtime thinking state

        self.agents_surrendered = []  # List of surrendered agents
        self.active_agent_index = None  # Index of the active agent, if applicable
    ...
    def set_active_agent_index(self, agent_index: int):
        """Set the index of the active agent."""
        self.active_agent_index = agent_index

    def surrender(self):
        self.agents_surrendered.append(self.active_agent_index)
